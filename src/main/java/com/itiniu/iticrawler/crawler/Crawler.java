...
import com.itiniu.iticrawler.behaviors.robotstxt.RobotsTxtBehavior;
 ...
 * the {@link CrawlBehavior} Interface at the respective stages.
 *
...
public class Crawler implements Runnable
{
	...
	private RobotsTxtBehavior robotTxtBehavior = null;

	// The Behaviors
	private CrawlBehavior customCrawlBehavior = null;
	...
	public Crawler(Frontier frontier, RobotsTxtCache robotTxtData,
			CrawlBehavior customCrawlBehavior, RobotsTxtBehavior robotTxtBehavior,
	 ...
	 * {@link CrawlBehavior#handleStatuScode(Page)}.
	 *
	 * @param page
	 */
	...
	/**
	 * Internal wrapper method to wrap the call of
	 * {@link CrawlBehavior#handleContentSize(Page)}.
	 *
	 * @param page
	 */
	...
	/**
	 * Internal wrapper method to wrap the call of
	 * {@link CrawlBehavior#processPage(Page)}.
	 *
	 * @param page
	 */
	...
	/**
	 * Internal wrapper method to wrap the call of
	 * {@link CrawlBehavior#handleOutgoingURLs(Page)}.
	 *
	 * @param page
	 */
	 ...
	 * {@link CrawlBehavior#processPage(Page page)} as last instance.
	 *
	 * @param page
	 */

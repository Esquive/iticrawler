...
public class SimpleRobotRules extends BaseRobotRules {
    ...
    {
        if(allow)
            _mode = RobotRulesMode.ALLOW_ALL;
    }

    public void setAllowNone(boolean none)
    {
        if (none)
            _mode = RobotRulesMode.ALLOW_NONE;
    }
    ...
    public ArrayList<RobotRule> get_rules() {
        return _rules;
    }

    public void set_rules(ArrayList<RobotRule> _rules) {
        this._rules = _rules;
    }

    public RobotRulesMode get_mode() {
        return _mode;
    }

    public void set_mode(RobotRulesMode _mode) {
        this._mode = _mode;
    }
}

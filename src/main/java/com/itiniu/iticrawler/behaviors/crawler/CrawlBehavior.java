package com.itiniu.iticrawler.behaviors.crawler;

import com.itiniu.iticrawler.crawler.Page;
 ...
 * be initialized. </br> </br>1: {@link CrawlBehavior#handleStatuScode(Page)}
 * gets called first. </br>2: {@link CrawlBehavior#handleContentSize(Page)}
 * gets called second. </br>3: {@link CrawlBehavior#processPage(Page)} gets
 * called third. </br>4: {@link CrawlBehavior#handleOutgoingURLs(Page)} gets
 * called forth. </br>5: {@link CrawlBehavior#shouldScheduleURL(com.itiniu.iticrawler.httptools.impl.URLInfo)}
